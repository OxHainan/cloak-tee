 ...
 * memory. */
static void secp256k1_fe_inv_all_var(
  secp256k1_fe* r, const secp256k1_fe* a, size_t len);
...
static void secp256k1_fe_from_storage(
  secp256k1_fe* r, const secp256k1_fe_storage* a);

/** If flag is true, set *r equal to *a; otherwise leave it. Constant-time. */
static void secp256k1_fe_storage_cmov(
