...
#include "service/tables/view_change.h"
    ...
    const ConsensusType& consensus_type)
{
    return std::make_shared<
        kv::Store>(aft::replicate_type, aft::replicated_tables);
}
